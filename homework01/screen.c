...
const char* Story_Text1[] = {"이 게임은 매우 지극히 주관적이며 실제와 다를 수 있습니다. ","일부 스토리는 개발자의 실화를 바탕으로 만들어졌습니다.", "이 게임은 Enter키를 눌러 넘길 수도 있고 다른 입력을 요구 할 수 있습니다."};
